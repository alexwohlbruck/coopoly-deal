...
export function WaitingRoom({ gameState, playerId, onStartGame, onAddBot, onRemovePlayer, musicControls }: WaitingRoomProps) {
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-white/20 mb-4">
          ...
          <div className="space-y-2">
            {gameState.players.map((player, i) => (
              ...
              >
                <div className={`w-8 h-8 rounded-full ${player.isBot ? "bg-blue-500" : "bg-emerald-500"} flex items-center justify-center text-white font-bold text-sm`}>
                ...
                {player.id === playerId && (
                  <span className="text-emerald-400 text-xs ml-auto">(you)</span>
                )}
                {i === 0 && !player.isBot && (

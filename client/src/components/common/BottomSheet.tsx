      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed bottom-0 left-0 right-0 mx-auto z-[110] w-full ${maxWidth} ${height} bg-gray-900 rounded-t-3xl shadow-2xl border-t-2 border-white/20 flex flex-col`}
          >
            {/* Header */}
